...
public class WheelDateTimePicker {
    ...
    private static int START_YEAR = 2017, END_YEAR = 2050;
    ...
    public WheelDateTimePicker(View view, boolean hasSelectTime) {
        super();
        this.view = view;
    ...
    public void initDateTimePicker(int year, int month, int day, int h, int m) {
        ...
        int textSize = 0;
        if (hasSelectTime)
            textSize = (int) (screenheight / 100.0 * 2.5);
        else
    ...
    public String getTime() {
        ...
        if (!hasSelectTime) {
            sb.append((year + START_YEAR)).append("-")
