...
public class PedometerReportAxisYView2 extends View {
	...
	public PedometerReportAxisYView2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onDraw(Canvas c) {
		...
		c.drawText("3000",  getWidth()/2 - ActivityUtil.getFontlength(paint_line, "3000") / 2.0f, getHeight() - interval_bottom + ActivityUtil.getFontHeight(paint_line) / 4.0f - 1 * base, paint_line);
