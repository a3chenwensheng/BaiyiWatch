...
public class HeartRateAxisYView2 extends View {
	...
	public HeartRateAxisYView2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onDraw(Canvas c) {
		...
		c.drawText("50",  getWidth()/2 - ActivityUtil.getFontlength(paint_line, "50") / 2.0f, getHeight() - interval_bottom + ActivityUtil.getFontHeight(paint_line) / 4.0f - 50 * base, paint_line);
		c.drawText("100",  getWidth()/2 - ActivityUtil.getFontlength(paint_line, "100") / 2.0f, getHeight() - interval_bottom + ActivityUtil.getFontHeight(paint_line) / 4.0f - 100 * base, paint_line);
