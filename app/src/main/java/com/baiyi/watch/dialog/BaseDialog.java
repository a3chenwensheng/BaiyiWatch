...
public class BaseDialog extends Dialog implements
	...
	private TextView mHtvRemark;// 备注
	...
	private void initViews() {
		...
		mHtvRemark = (TextView) findViewById(R.id.dialog_generic_htv_remark);
	...
	public void setRemarkGravity(int gravity){
		mHtvRemark.setGravity(gravity);
	}

	public void setRemark(CharSequence text) {
		if (text != null) {
			mHtvRemark.setText(text);
		}
	}
	
	public void setAutoLink() {
		mHtvMessage.setAutoLinkMask(Linkify.PHONE_NUMBERS);
	}
